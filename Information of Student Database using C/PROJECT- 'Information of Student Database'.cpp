...
void Login()
{
    ...
    void Notice_Board()
    {
        ...
        printf("URGENT NEWS:-\n\n");
        printf("(1)ADMISSION FOR Spring-2016 is going on,The Dates of Undergraduate Admission Test:\n");
        printf("=>(BBA,ENG,ECO, Sociology)12 December 2015 at 10:00 AM\n=>(CSE,ICE,ETE,EEE,Genetic,Pharmacy,Applied Statistics)12 December 2015 at 02:30PM\n");
        printf("(2)Application Deadline:15 December 2015 by 2:00PM\n\n");
        printf("LATEST NEWS:-\n\n");
        ...
        printf("Mentoring Day of FIREFOX,Held at ICS Lab on November 27,2015(Time-4:00PM)\n");
        printf("In CCC the BCCP Program held on August 20,2015(Time-9:00AM)\n\n");
